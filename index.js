...
نورت الجروب يقمر يجب احترام الادمن والالتزام بالقوانين في الوصف♥`} )
                } else if (anu.action == 'remove') {
                    XeonBotInc.sendMessage(anu.id, { image: Tol, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} غادر ${metadata.subject}

حد يخرج من جررب قمر زي دا ↯دا حتا كلنا اخوات واصحاب♥✨` })
                }
            }
        } catch (err) {
            console.log(err)
